...
import com.BoardMaria.util.Page;
...
public class BoardController {
	...
	public void getList(HttpSession session, @RequestParam("page") int pageNum, @RequestParam(name="keyword",defaultValue="",required=false) String keyword, Model model) throws Exception{
	...
	public void getView(@RequestParam("seqno") int seqno, Model model, @RequestParam("page") int pageNum,
				HttpSession session, @RequestParam(name="keyword",defaultValue="", required=false) String keyword) throws Exception{
	...
	public String postSignup(User user, Model model) throws Exception {
