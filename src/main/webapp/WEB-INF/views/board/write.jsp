...
<script>
	...
	window.onload = () =>{
		...
		//파일 탐색 창을 열어 선택한 파일 정보를 files에 할당
		...
		*/
		...
		// 자동으로 prototype이 만들어지고 여기에 기본적으로 Object 객체를 상속하게끔 한다. 
		//기존 내장 객체(Array, FormData...)도 본인객체 외에 prototype을 가지고 있음.
		...
		filesArr.forEach((file) => {
			//FileReader 객체 : 웹 애플리케이션이 비동기적으로 웹브라우저에서 파일을 읽을 때 사용하며, 
...
%>
	<div>
	    <img id="topBanner" src ="/resources/images/logo.jpg" title="서울기술교육센터" onclick="document.location.href='/board/list?page=1'">
	  	</div>
	<div class="main">
		<div class="WriteDiv">
