...
.userid, .username, .userpasswd, .userpasswd1, .telno, .email, .zip, .addr1, .addr2, .hobby {
  width: 80%;
  border:none;
...
<div class="main" align="center">
  <div class="registerForm">
    ...
    <form name="registerForm" id="registerForm" method="post" enctype="multipart/form-data"> 
    	...
    	<center><div id="ImageRegistration"><img src='/profile/${user.stored_filename}' style='width:300px; height:auto;'></div></center>
        ...
        <input type="text" id="zip" class="zip" name="zip" value="${user.zipcode}" disabled>
        ...
        <input type="text" id="email" name="email" class="email" value="${user.email}"><br><br>
       <div style="width:90%; text-align:left; position:relative; left: 35px; border-bottom:2px solid #adadad; margin:10px; padding: 10px;">
			...
			<textarea class="input_content" id="description" cols="100" rows="25" name="description" placeholder="자기소개를 입력해 주세요.">
			</textarea><br>
